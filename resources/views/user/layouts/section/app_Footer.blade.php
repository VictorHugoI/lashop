<footer class="footer">
                ...
                <div id="brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        @foreach($brands as $brand)
                            <div class="item"> <a href="#x"><img src="{{ url($brand->url_footer) }}" alt="Image"></a> </div>
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <div class="footer-middle container">
        <div class="col-md-3 col-sm-4">
            <div class="footer-logo"><a href="index.html" title="Logo"><img src="{{ url('images/footer-logo.png') }}" alt="logo"></a></div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus diam arcu. </p>
            <div class="payment-accept">
                <div>
                    <img src="{{ url('images/payment-1.png') }}" alt="payment">
                    <img src="{{ url('images/payment-2.png') }}" alt="payment">
                    <img src="{{ url('images/payment-3.png') }}" alt="payment">
                    <img src="{{ url('images/payment-4.png') }}" alt="payment">
                </div>
            </div>
        </div>
