<div class="modal-content">
    ...
    {!! Form::open(['route' => ['property.update', $property->id], 'method' => 'PUT', 'class' => 'updateProper']) !!}
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-primary btnUpdate" style="margin-right: 10px" data-dismiss="modal">
            Update
        </button>
