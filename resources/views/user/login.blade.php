                    ...
                    <div class="col-1 new-users"><strong>New Customers</strong>
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <button onclick="window.location='{{ url('/register') }}';" class="button create-account" type="button"><span>{{ trans('user/label.create_account') }}</span></button>
                            </div>
                        </div>
                    </div>
                    {!! Form::open(['route' => 'login', 'method' => 'POST']) !!}
                        <div class="col-2 registered-users"><strong>Registered Customers</strong>
                            <div class="content">
                                ...
                                <ul class="form-list">
                                    <li>
                                        <label for="email">{{ trans('user/label.email') }} <span class="required">*</span></label>
                                        <br>
                                    ...
                                    <li>
                                        <label for="pass">{{ trans('user/label.password') }} <span class="required">*</span></label>
                                        <br>
